...
class PaymentAccountCreationView extends StatefulWidget {
  const PaymentAccountCreationView({
    super.key,
  });

  @override
  State<PaymentAccountCreationView> createState() =>
      _PaymentAccountCreationViewState();
}

class _PaymentAccountCreationViewState
    extends State<PaymentAccountCreationView> {
