        ...
        if (state.updateStatus == ContactInformationUpdateStatus.updating()) {
          if (state.usernameErrorMessage == null) {
            contactInformationEditBloc.add(
              ContactInformationEditEvent.updateUsername(
              ...
              actions: [
                SizedBox(
                  ...
                  child: MATextButton(
                    ...
                    onPressed: () {
                      contactInformationEditBloc.add(
                        const ContactInformationEditEvent.validateUsername(),
                      );
                      contactInformationEditBloc.add(
                        ContactInformationEditEvent.setUpdateStatus(
                  ...
                  BlocBuilder<ContactInformationEditBloc, ContactInformationEditState>(
                    ...
                    builder: (context, state) {
                      return MATextFormField.username(
                        initialValue: userBloc.state.user.username,
                        ...
                        onChanged: (value) {
                          contactInformationEditBloc.add(
                            ContactInformationEditEvent.setDefaultUsername(value),
                          );
                        },
                        errorText: state.usernameErrorMessage,
                        hasError: state.usernameErrorMessage != null,
                      );
                    },
                  ),
                ],
