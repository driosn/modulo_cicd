...
class PaymentAccountCreationAutopayView extends StatefulWidget {
  const PaymentAccountCreationAutopayView({
    super.key,
  });

  @override
  State<PaymentAccountCreationAutopayView> createState() =>
      _PaymentAccountCreationAutopayViewState();
}

class _PaymentAccountCreationAutopayViewState
    extends State<PaymentAccountCreationAutopayView> {
