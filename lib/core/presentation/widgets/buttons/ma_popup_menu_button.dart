...
// ignore_for_file: unnecessary_null_comparison, always_put_required_named_parameters_first, use_named_constants, deprecated_member_use
...
const double _kMenuMaxWidth = 355;
...
/// shows a popup menu, consider using [MAPopupMenuButton].
///
...
///  * [MAPopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
// item lines up with the center of its MAPopupMenuButton.
...
/// {@end-tool}
///
/// See the example at [MAPopupMenuButton] for how this example could be used in a
...
class PopupMenuItem<T> extends PopupMenuEntry<T> {
  ...
  //
  // Makes PopUpMenuItem static with no tap interactions
  //
  final bool staticRender;
...
class _PopupMenuRouteLayout extends SingleChildLayoutDelegate {
  ...
  // The index of the selected item, or null if MAPopupMenuButton.initialValue
  // was not specified.
...
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [MAPopupMenuButton], which provides an [IconButton] that shows a menu by
...
/// dismissed.
///
/// Used by [MAPopupMenuButton.onSelected].
typedef PopupMenuItemSelected<T> = void Function(T value);

/// Signature for the callback invoked when a [MAPopupMenuButton] is dismissed
/// without selecting an item.
///
/// Used by [MAPopupMenuButton.onCanceled].
typedef PopupMenuCanceled = void Function();

/// Signature used by [MAPopupMenuButton] to lazily construct the items shown when
/// the button is pressed.
///
/// Used by [MAPopupMenuButton.itemBuilder].
...
/// then [MAPopupMenuButton] behaves like an [IconButton].
///
...
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
class MAPopupMenuButton<T> extends StatefulWidget {
  /// Creates a button that shows a popup menu.
  ///
  /// The [itemBuilder] argument must not be null.
  const MAPopupMenuButton({
    super.key,
  ...
  @override
  MAPopupMenuButtonStateChild<T> createState() =>
      MAPopupMenuButtonStateChild<T>();
}

/// The [State] for a [MAPopupMenuButton].
///
/// See [showButtonMenu] for a way to programmatically open the popup menu
/// of your button state.
class MAPopupMenuButtonStateChild<T> extends State<MAPopupMenuButton<T>> {
  /// A method to show a popup menu with the items supplied to
  /// [MAPopupMenuButton.itemBuilder] at the position of your [MAPopupMenuButton].
  ///
  /// By default, it is called when the user taps the button and [MAPopupMenuButton.enabled]
  /// is set to `true`. Moreover, you can open the button by calling the method manually.
  ///
  /// You would access your [MAPopupMenuButtonStateChild] using a [GlobalKey] and
